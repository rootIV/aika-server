...
begin
  ...
  begin
    Logger.Write(ServerList[Self.ChannelId].Name +
      ' Conex�o geral do MySQL aberta. [' + MYSQL_SERVER + ':' +
  ...
  begin
    Logger.Write
      ('N�o foi poss�vel abrir conex�o geral do MySQL para o Servidor.',
      TLogType.Warnings);
...
begin
  ...
  case Header.Code of
    ...
    $668:
      try
        Player.SendClientMessage('Essa fun��o foi temporariamente desativada.');
